...
//https://github.com/stephentoub/corefx/blob/54ec4d0ad3c13856e254368f9e65c74e1d90358a/src/System.Collections.Concurrent/src/System/Collections/Concurrent/ConcurrentDictionary.cs
namespace KitsTajm.Helpers
{
    /// <summary>
    ...
    public class ConcurrentDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary, IReadOnlyDictionary<TKey, TValue>
    {
        ...
        {
            public const string ConcurrentDictionary_ArrayIncorrectType = "ConcurrentDictionary_ArrayIncorrectType";
            public const string ConcurrentDictionary_ArrayNotLargeEnough = "ConcurrentDictionary_ArrayNotLargeEnough";
            public const string ConcurrentDictionary_CapacityMustNotBeNegative = "ConcurrentDictionary_CapacityMustNotBeNegative";
            public const string ConcurrentDictionary_ConcurrencyLevelMustBePositive = "ConcurrentDictionary_ConcurrencyLevelMustBePositive";
            public const string ConcurrentDictionary_KeyAlreadyExisted = "ConcurrentDictionary_KeyAlreadyExisted";
            public const string ConcurrentDictionary_IndexIsNegative = "ConcurrentDictionary_IndexIsNegative";
            public const string ConcurrentDictionary_ItemKeyIsNull = "ConcurrentDictionary_ItemKeyIsNull";
            public const string ConcurrentDictionary_SourceContainsDuplicateKeys = "ConcurrentDictionary_SourceContainsDuplicateKeys";
            public const string ConcurrentCollection_SyncRoot_NotSupported = "ConcurrentCollection_SyncRoot_NotSupported";
            public const string ConcurrentDictionary_TypeOfKeyIncorrect = "ConcurrentDictionary_TypeOfKeyIncorrect";
            public const string ConcurrentDictionary_TypeOfValueIncorrect = "ConcurrentDictionary_TypeOfValueIncorrect";
        }
